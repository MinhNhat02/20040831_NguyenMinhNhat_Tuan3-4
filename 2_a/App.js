    ...
    <View style={styles.container}>
      ...
      <View style={styles.containerInput}>
        <View style={styles.rowInput}>
          <Image source={require("./assets/avatar_user 1.png")} style={[styles.icon, { width: 32, height: 32 }]}/>
        ...
        <View style={styles.rowInput}>
          ...
          <TouchableOpacity>
            <Image source={require("./assets/eye 1.png")} style={[styles.icon2, { width: 32, height: 32 }]}/>
          </TouchableOpacity>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  rowInput: {
    ...
    display: "flex",
    flexDirection: "row",
    backgroundColor: "rgb(196, 196, 196, 0.3)",
    alignItems: "center",
    borderWidth: 1,
    borderColor: "#fff",
  },
